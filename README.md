...
Accuracy for client 3 :  0.7692307692307693
Precision for client 3 :  0.7692307692307693
Recall for client 3 :  1.0
...
2. Run [build.sh](build.sh) to create the environment. You only need to do this once.
   
        chmod +x build.sh
        ./build.sh
2. Run the following commands to simulate each three scenarios :
